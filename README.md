...
Create a folder on your server and place the docker-compose.yml file inside it.

2. Configure Volumes

Open docker-compose.yml and ensure the volumes map to your actual media folders.
...
git clone [https://github.com/johnfawkes/plex-poster-downloader.git](https://github.com/johnfawkes/plex-poster-downloader.git)
...
Authentication: You will be asked to create an Admin Username and Password.
...
Hidden Libraries: You can uncheck libraries you don't want to manage (e.g., Home Videos, Music).
